...
import { Users, Plus, Filter, FileText, ChevronDown, Upload, Download, AlertCircle, CheckCircle } from 'lucide-react';
...
const Header = ({
  ...
  // Handle filter dropdown click to prevent closing
