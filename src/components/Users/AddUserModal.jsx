  ...
  useEffect(() => {
    const initializeModal = async () => {
      ...
      if (isAuth) {
        ...
        await fetchRoles(); // Fetch roles when component mounts
      }
    };
    initializeModal();
  }, [checkAuth, fetchCompanyDetails, fetchRoles]);
    ...
    try {
      ...
      if (errorData?.errors && typeof errorData.errors === 'object') {
        ...
        Object.keys(backendErrors).forEach(field => {
          const errorMsg = Array.isArray(backendErrors[field]) ? backendErrors[field][0] : backendErrors[field];
          const fieldMap = {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block mb-1 text-sm font-medium text-gray-700">
                ...
                Role <span className='text-lg text-red-600'>*</span>
              </label>
              <select
                name="role"
                value={formData.role}
